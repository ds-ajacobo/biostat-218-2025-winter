...
querySql(syn_connection,
         sql = "SELECT MIN(DATEDIFF('day', OBSERVATION_PERIOD_START_DATE, OBSERVATION_PERIOD_END_DATE)) AS MIN_OBSERVATION_PERIOD_START_DATE
                     , MAX(DATEDIFF('day', OBSERVATION_PERIOD_START_DATE, OBSERVATION_PERIOD_END_DATE)) AS MAX_OBSERVATION_PERIOD_END_DATE
