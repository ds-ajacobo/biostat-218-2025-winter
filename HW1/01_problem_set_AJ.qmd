...
absoluteFileName <- "C:/Users/ajaco/OneDrive/Documents/UCLA/BIOSTATS_218/biostat-218-2025-winter/data/synthetic.duckdb" 
...
```{r}
querySql(connection = connection,
         sql = "SELECT MIN(OBSERVATION_DATETIME) AS MIN_OBSERVATION_DATETIME
                     , MAX(OBSERVATION_DATETIME) AS MAX_OBSERVATION_DATETIME
                     , AVG(DATEDIFF('day', OBSERVATION_DATETIME, OBSERVATION_DATETIME)) AS AVG_OBSERVATION_DAYS
                FROM observation;")
```
