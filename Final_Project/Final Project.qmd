...
The LEGEND-T2DM Class Sensitivity Evidence Explorer tool was used to calculate the hazard ratios (HR) for GLP1RA vs SGLT2i across data sources for the outcome of glycemic control. The full results are shown in Table \ref{tab:full_hazard_ratios}. When comparing the hazard ratios (HR) for target group vs the comparator group, we find that GLP1RA has a higher risk of poor glycemic control compared to SGLT2i. Table \ref{tab:hazard_ratios} shows the summary of the hazard ratios. The unadjusted HRs for GLP1RA vs SGLT2i are 1.30 - 1.38, indicating that GLP1RA has a higher risk of poor glycemic control compared to SGLT2i. Using a matching methodology to adjust for confounders, the HRs are reduced but still show a higher risk of poor glycemic control for GLP1RA compared to SGLT2i. The PS stratification method shows the lowest HRs. Using the different methodologies, we can see that the PS stratification method is the most effective at reducing bias. However, across all methods, GLP1RA still shows a higher risk of poor glycemic control compared to SGLT2i.
