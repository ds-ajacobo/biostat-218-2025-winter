...
:::: {.tbl-cap}
| Data Source | Unadjusted HR | PS Matching HR | PS Stratification HR | 
|--------------|--------------|--------------|--------------|
...
**Table 1. Hazard Ratios for GLP1RA vs. SGLT2i Across Data Sources**
::::
...
:::: {.tbl-cap}
**Table 2. Comparison of HR Ranges for On-Treatment (OT) vs. Intent-to-Treat (ITT) Analysis**
::::

| Method | HR Range (OT) | HR Range (ITT) | 
|----------------|----------------|----------------|
